...
const Profile = () => {
    ...
    useEffect(() => {
        if (showChangePhoto && fileInputRef.current) {
    ...
    return (
        <div className="profile-container">
            {acknowledgement && <div className="alert alert-success">{acknowledgement}</div>}
            <div className="profile-top-card">
                <div className="profile-picture" onClick={() => setShowPhotoOptions(true)}>
                    {profile.photo ? (
                        <img 
                ...
                {showChangePhoto && (
                    <div className="change-photo-popup">
                        ...
                        />
                        <button onClick={handleSubmitPhoto} className='photochange'>OK</button>
                        <button onClick={() => setShowChangePhoto(false)} className='cancel'>Cancel</button>
                    </div>
                )}
